    ...
    <div>
      ...
      <div>
        <div className="flex justify-end items-center gap-2">
          <p className="font-semibold">Display Layout</p>
          <div>
            <span onClick={() => handleDisplayLayoutBtn('list')} className="btn">List</span>
            <span onClick={() => handleDisplayLayoutBtn('grid')} className="btn">Grid</span>
          </div>
        </div>
        {/* --------------------- display view ------------------------- */}
        {
