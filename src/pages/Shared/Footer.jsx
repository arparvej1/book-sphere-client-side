  ...
  return (
    <footer className="mt-10 p-10 bg-base-200 text-base-content rounded">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 text-center md:text-start gap-3">
          <div className="flex flex-col gap-2 md:col-span-2">
            ...
            <p className="md:w-3/4">
              BookSphere Headquarters
              456 Reader's Boulevard,
              Libraryville, Bookland
              Novelshire, Literaria.
            </p>
      ...
      <aside className="text-center mt-5 md:mt-10">
        <p>Copyright © 2024 - All right reserved by <Link to='/'><strong>BookSphere</strong></Link></p>
      </aside>
    </footer>
  );
};
